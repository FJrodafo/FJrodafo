    ...
    <footer className='footer'>
      <div className='footer__container container'>
        ...
        <ul className='footer__list'>
          ...
          <li><a href='#portfolio' className='footer__link'>{t('footer.portfolio')}</a></li>
        </ul>
        <div className='footer__social'>
          ...
          <a href='https://discord.com/users/549577369342574602' className='footer__social-link' target='_blank' rel='noreferrer'><i className='bx bxl-discord-alt' /></a>
