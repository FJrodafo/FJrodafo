        ...
        <div className='qualification__sections'>
          <div className={toggleState === 1 ? 'qualification__content qualification__content-active' : 'qualification__content'}>
            <div className='qualification__data'>
              <div>
                <h3 className='qualification__title'>Ciclo Formativo de Grado Superior, Desarrollo de aplicaciones web</h3>
            ...
            <div className='qualification__data'>
              ...
              <div>
                <h3 className='qualification__title'>Interpretación musical, Trompeta</h3>
