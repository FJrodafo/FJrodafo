<div align="center">
    <a href="https://fjrodafo.vercel.app/">
        <picture>
            <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/FJrodafo/FJrodafo/main/App/src/assets/images/preview/dark.png">
            <img alt="Preview" src="https://raw.githubusercontent.com/FJrodafo/FJrodafo/main/App/src/assets/images/preview/light.png">
        </picture>
    </a>
</div>
...
To check if you already have Node installed on your machine, run `node -v` in your terminal. Otherwise, you will need to install Node v18 or higher or, as a last option, check out the [Docker](#docker) alternative.
