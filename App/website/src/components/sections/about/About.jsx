...
import CV from '../../../assets/FJrodafo-CV.pdf';
  ...
  return (
    <section className='about section' id='about'>
      ...
      <div className='about__container container grid'>
        <a href='https://fjrodafo-cv.vercel.app/' className='about__link'>
          <img src={AboutImg} alt='' className='about__img' />
        </a>
        <div className='about__data'>
          <Info />
          <p className='about__description'>{t('about.description')}</p>
          <a download='' href={CV} className='button button--flex'>{t('about.button')}
